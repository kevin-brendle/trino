        ...
        extends AbstractIcebergTableOperations
{
            ...
            Optional<String> location)
    {
        ...
        this.icebergSnowflakeTableOperations = requireNonNull((SnowflakeTableOperations) trinoSnowflakeCatalog.getIcebergSnowflakeCatalog().newTableOps(tableIdentifier), "snowflakeTableOperations is null");
    }
    ...
    {
        throw new TrinoException(NOT_SUPPORTED, "commitNewTable is not supported for Iceberg Snowflake catalogs");
    }

    @Override
    protected void commitToExistingTable(TableMetadata base, TableMetadata metadata)
    {
        throw new TrinoException(NOT_SUPPORTED, "commitToExistingTable is not supported for Iceberg Snowflake catalogs");
    }

    @Override
    protected void commitMaterializedViewRefresh(TableMetadata base, TableMetadata metadata)
    {
        throw new TrinoException(NOT_SUPPORTED, "commitMaterializedViewRefresh is not supported for Iceberg Snowflake catalogs");
    }
}
